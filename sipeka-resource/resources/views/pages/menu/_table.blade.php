...
<table id="kt_datatable" class="table table-row-dashed gy-5 gs-7 rounded">
    <thead>
        <tr class="fw-bolder fs-6 text-gray-800 text-uppercase px-7">
            ...
            <th class="min-w-200px w-200px">Menu</th>
            <th class="min-w-200px w-200px">Parent</th>
            <th class="min-w-100px w-100px">Ikon</th>
            <th class="min-w-100px w-100px">Route</th>
            <th class="min-w-100px w-100px">Urutan</th>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return `<span class="badge badge-light-info">${row.route}</span>`
                        }
                    },
                    {
                        data: 'order',
