@extends('layouts.app')
@section('meta_title', 'Manajemen Pengguna')
...
<div class="card mb-5 mb-xl-8">
  <div class="card-header border-0 pt-5">
    <h3 class="card-title align-items-start flex-column">
      <span class="card-label fw-bolder fs-3 mb-1">Manajemen Unit Kerja</span>
      <span class="text-muted mt-1 fw-bold fs-7">Kelola data unit organisasi</span>
    </h3>
    <div class="card-toolbar">
      <a href="{{ route('unor.create') }}" class="btn btn-light-primary">
