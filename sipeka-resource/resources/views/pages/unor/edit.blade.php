...
@section('content')
    <div class="card mb-5 mb-xl-8">
        <div class="card-body">
            <form class="form w-100" id="form_create_unor" action="{{ route('unor.update', $model->id) }}" method="POST">
                @csrf
                @method('PUT')
                <x-field-input label-name="Kode Unit" field-name="unor_code" model="{{ $model->unor_code }}" placeholder="Kode Unit" />
                <x-field-input label-name="Unit Kerja" field-name="unor_name" model="{{ $model->unor_name }}" placeholder="Unit Kerja" />
