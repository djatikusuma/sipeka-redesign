...
<table id="kt_datatable" class="table table-row-dashed gy-5 gs-7 rounded">
    <thead>
        <tr class="fw-bolder fs-6 text-gray-800 text-uppercase px-7">
            ...
            <th class="min-w-80px w-80px">Kode Unit</th>
            <th class="min-w-200px w-200px">Unit Kerja</th>
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `<span class="badge badge-light-info">${row.unor_code.toUpperCase()}</span>`;
                        }
                    },
                    {
                        data: 'unor_name'
